...
const Product = (prop) => {
    let {pObj,delt,mVis}=prop;//object destructuring
    ...
    <div className="col">
        ...
        <div className="card-body">
            ...
            <button className="btn btn-primary" onClick={()=>mVis(pObj)}>edit</button>
            <button className="btn btn-danger" onClick={()=>delt(pObj.id)}>delete</button>
            </div>
        </div>
        </div>
    </div>
